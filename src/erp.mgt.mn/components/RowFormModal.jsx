...
const RowFormModal = function RowFormModal({
  ...
  function resolvePrintPayloadFromResult(result, rowsOverride = null) {
    ...
    return buildPrintPayload(rowsOverride, result);
  }
  ...
  function handlePrint(modes = [], payload = null, copiesValue = 1) {
    ...
    html +=
      `<style>@page{size:auto;margin:${pageMargin};}@media print{body{margin:0;}.print-group{break-inside:avoid;page-break-inside:avoid;}}body{margin:0;font-size:${fontSize};} .print-sheet{font-size:inherit;max-width:100%;} .print-group{margin-bottom:${groupSpacing};} .print-copies{display:grid;grid-template-columns:1fr;gap:${gapSize};} .print-copies.print-copies-grid{grid-template-columns:repeat(2,minmax(0,1fr));} .print-item{break-inside:avoid;} table{width:100%;border-collapse:collapse;margin-bottom:1rem;table-layout:auto;} th,td{padding:4px;text-align:left;vertical-align:top;overflow-wrap:anywhere;word-break:break-word;white-space:normal;font-size:inherit;} .print-main-table th,.print-main-table td{border:1px solid #666;} h3{margin:0 0 4px 0;font-weight:600;}</style>`;
