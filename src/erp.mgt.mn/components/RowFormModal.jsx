...
const RowFormModal = function RowFormModal({
  ...
  function handlePrint(mode, payload = null) {
    ...
    html +=
      '<style>@media print{body{margin:0.5rem;font-size:10px}}@page{margin:0.5rem;}table{border-collapse:collapse;margin-bottom:0.5rem;width:auto !important;max-width:100%;border:none !important;}h3{margin:0 0 4px 0;font-weight:600;font-size:10px;}th,td{padding:2px 4px;text-align:left;border:none !important;}table.plain-table,table.signature-table{border:none !important;}table.data-table{border:none !important;}.data-table th,.data-table td{border:1px solid #666 !important;}.plain-table th,.plain-table td{border:none !important;}.signature-table th,.signature-table td{vertical-align:bottom;border:none !important;}.signature-line{border-bottom:1px solid #111 !important;height:1.2rem;}</style>';
    html += '</head><body>';
    if (h.length) {
