...
const TableManager = forwardRef(function TableManager({
  ...
  function resolveFilterValue(column, rawValue) {
    ...
    if (Array.isArray(searchEntries) && searchEntries.length > 0) {
      ...
      // When a relation column exists but the typed text does not match any option,
      // skip applying the filter to avoid clearing the table until a valid choice is made.
      return null;
    }
