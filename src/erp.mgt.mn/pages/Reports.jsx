      ...
      try {
        ...
        if (!cancelled) {
          ...
          if (workplaceFetchDiagnosticsEnabled) {
            ...
            const normalizedRawSql = normalizeSqlDiagnosticValue(
              diagnostics?.sql,
            );
            const normalizedFormattedSql = normalizeSqlDiagnosticValue(
              formattedSql ?? diagnostics?.formattedSql,
            );
            let formattedSqlForToast = normalizedFormattedSql;
            if (
              normalizedRawSql &&
              (!formattedSqlForToast || formattedSqlForToast === normalizedRawSql)
            ) {
              formattedSqlForToast = normalizedRawSql;
            }
