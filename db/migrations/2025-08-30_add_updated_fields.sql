-- Add updated_by and updated_at columns to all base tables (skip views)
-- Mirrors FK/indexes from created_by when present
...
BEGIN
  ...
  read_loop: LOOP
    ...
    -- Mirror foreign key from created_by -> updated_by
    IF EXISTS (
      ...
      SELECT REFERENCED_TABLE_NAME, REFERENCED_COLUMN_NAME
        INTO fk_ref_table, fk_ref_column
    ...
    -- Mirror index from created_by -> updated_by
    IF EXISTS (
