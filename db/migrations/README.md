...
- `2026-02-11_messaging_company_id_not_null.sql`: Backfills NULL `company_id` values to `0` and enforces `NOT NULL` on messaging message/thread tables when those tables exist.
