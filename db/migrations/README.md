...
- `2025-11-07_contract_receivables_static_trigger.sql`: Replaces the contract receivables trigger/procedure with static SQL that is safe to run from promotion triggers by avoiding any dynamic statements.
