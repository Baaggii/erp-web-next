...
function mapEmploymentRow(row) {
  ...
  return {
    ...
    pos_no: resolvedPosNo,
    posNo: resolvedPosNo,
    pos_name,
    branchNo: resolvedPosBranchNo,
    pos_districtCode: resolvedPosDistrictCode,
    merchantTin: resolvedPosMerchantTin,
    pos_branch_no: resolvedPosBranchNo,
    pos_district_code: resolvedPosDistrictCode,
    pos_merchant_tin: resolvedPosMerchantTin,
    pos_number: resolvedPosNo,
    pos_number_resolved: resolvedPosNo,
    merchant_id,
    merchant_tin,
    ...rest,
    permissions,
