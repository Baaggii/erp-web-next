...
function parseEntry(raw = {}) {
  ...
  return {
    ...
    notificationCompanyFields: arrify(raw.notificationCompanyFields),
    notificationDepartmentFields: arrify(raw.notificationDepartmentFields),
    notificationBranchFields: arrify(raw.notificationBranchFields),
    notificationEmployeeFields: arrify(raw.notificationEmployeeFields),
    notificationCustomerFields: arrify(raw.notificationCustomerFields),
